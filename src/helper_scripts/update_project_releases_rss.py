...
org_list=["gardenlinux","cobaltcore-dev","gardener","ironcore-dev","cloudoperators","open-resource-discovery","open-component-model","openmfp","openmcp-project","platform-mesh","konfidence-project","luigi-project","openkcm","chantico-project"]
