...
projects:
  ...
  - name: "Open Control Plane (OpenCP)"
    ...
    details: "The Open Control Plane (OpenCP) enables extensible Infrastructure- and Configuration-as-Data capabilities as a Service."
