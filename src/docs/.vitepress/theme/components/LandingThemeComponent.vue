...
<a href="https://https://www.bwi.de/events/termin/bwi-industry-days-2026-digitalisierungsoffensive-fuer-die-bundeswehr") class="kubecon-banner" target="_blank" rel="noopener"> <img :src="withBase('/assets/20260901_bwi_industry_days_banner_wide')" alt="BWI Industry Days" /> </a>
<a href="https://www.https://www.containerdays.io/containerdays-hamburg-2026/") class="kubecon-banner" target="_blank" rel="noopener"> <img :src="withBase('/assets/20260902_container_days_hamburg_banner_wide')" alt="Container Days Hamburg" /> </a>
...
<div>
  <section class="section-divider">
    ...
    <h2 class="section-divider__title">UPCOMING EVENTS</h2>
    <span class="section-divider__line"></span>
  </section>
  ...
  <EventsTilesThemeComponent :key="Date.now()" />
    ...
    <section class="section-divider">
    <span class="section-divider__line"></span>
    <h2 class="section-divider__title">LATEST FROM NEONEPHOS</h2>
    <span class="section-divider__line"></span>
  </section>
   <BlogGalleryTeaserThemeComponent /> 
    ...
    <section class="section-divider">
    <span class="section-divider__line"></span>
    <h2 class="section-divider__title">LEARN</h2>
    <span class="section-divider__line"></span>
   </section>
